...
def bestRule(iteration,fitnessRule): #nid to return a collection of dicts with the fitness and the rules; not only one rule
	...
	ruleSelected = {}
	overallfitnessIndividual[iteration] = sorted_x[0][1]
...
print("INITIALIZATION OF THE INDIVIDUAL ALGORITHM")
generation = 0	
...
fitListIndividual = sorted(overallfitnessIndividual.items()) # sorted by key, return a list of tuples
x2, y2 = zip(*fitListIndividual) # unpack a list of pairs into two tuples
plt.plot(x2, y2, label = "Grupal")
